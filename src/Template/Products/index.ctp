            ...
            <div class="box-body">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th><?= $this->Paginator->sort(__('price')) ?></th>
                        <th><?= $this->Paginator->sort(__('stock')) ?></th>
                        <th><?= $this->Paginator->sort(__('alert_quantity')) ?></th>
                    ...
                    <?php foreach ($products as $product): ?>
                        <tr class="<?= $this->StockStatus->status($product->stock->quantity ?? 0, $product->alert_quantity) ?>" >
                            <td><?= $this->Number->format($product->id) ?></td>
                            <td><?= h($product->title) ?></td>
                            <td><?= $this->FormatMoney->strToReais($product->price) ?></td>
