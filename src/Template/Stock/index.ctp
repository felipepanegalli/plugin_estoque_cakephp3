                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                                        ...
                                        <th><?= $this->Paginator->sort(__('product_id')) ?></th>
                                        <th><?= $this->Paginator->sort(__('quantity')) ?></th>
                                        <th><?= $this->Paginator->sort(__('unit_price')) ?></th>
                                        <th><?= $this->Paginator->sort(__('unit_cost')) ?></th>
